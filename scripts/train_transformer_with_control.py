...
def train_wrapper():
    ...
    model = transformer_model_category.TransformerModel_with_Category(ntokens, emsize, nhead, d_hid, nlayers, dropout).to(device)
    ...
    model = transformer_model_category_edited_3.TransformerModel_with_Category_edited(ntokens, emsize, nhead, d_hid, nlayers, dropout).to(device)
