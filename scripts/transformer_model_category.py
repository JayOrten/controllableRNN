...
class TransformerModel_with_Category(nn.Module):
    ...
    def __init__(self, ntoken: int, d_model: int, nhead: int, d_hid: int,
        ...
        self.category_embedding = nn.Embedding(10, d_model) # the first value is the total number of categories the vocab is expecting
