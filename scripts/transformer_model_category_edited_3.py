...
# This model only concatenates control info right before the feed forward layers, as well as the final ff layer
# Seems to perform worse when concatenating to the final linear layer
